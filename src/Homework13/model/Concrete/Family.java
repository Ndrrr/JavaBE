...
//    }
    ...
    public String prettyFormat(){
        ...
        stringBuilder.append("\tpets: "+pets + "\n");
        return stringBuilder.toString();
    }

    public static String toPrettyFormat(List<Family> list){
        StringBuilder sb = new StringBuilder();
//        list.stream()
//                .map(Family::prettyFormat)
//                .forEach(sb::append);
        IntStream.rangeClosed(1, list.size())
                .mapToObj(index -> "[" + index + "] " + list.get(index - 1).prettyFormat())
                .forEach(sb::append);
        return sb.toString();
    }
